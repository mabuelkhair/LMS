...
(function ($) {
    ...
    $.fn.tkWizard = function () {
        ...
        t.slick({
            ...
            onAfterChange: function (wiz, index) {
                $(document).trigger('http://themekit.aws.ipv4.ro/dist/themes/learning/after.wizard.step', {
                    wiz: wiz,
                    target: index,
                    container: container,
                    element: t
     ...
     */
    $(document).on('http://themekit.aws.ipv4.ro/dist/themes/learning/after.wizard.step', function (event, data) {
...
(function ($) {
    ...
    $.fn.tkSidebarSizePcDemo = function(){
        ...
        spc_demo.on('submit', function (e) {
            ...
            sidebar.open('http://themekit.aws.ipv4.ro/dist/themes/learning/sidebar-menu');
            clearTimeout(t);
            t = setTimeout(function () {
...
module.exports=require("../../../Code/html/themes/themekit/lib/essential/js/core/_skin.html")
...
require('http://themekit.aws.ipv4.ro/dist/themes/learning/_breakpoints.js');
require('http://themekit.aws.ipv4.ro/dist/themes/learning/_gridalicious.js');
require('http://themekit.aws.ipv4.ro/dist/themes/learning/_scrollable.js');
require('./_skins');
require('./_isotope');

// Sidebar Percentage Sizes Demo
require('./_sidebar-pc');
},{"./_breakpoints.js":"/Code/html/themes/themekit/lib/layout/js/_breakpoints.js","./_gridalicious.js":"/Code/html/themes/themekit/lib/layout/js/_gridalicious.js","./_isotope":"/Code/html/themes/themekit/lib/layout/js/_isotope.js","./_scrollable.js":"/Code/html/themes/themekit/lib/layout/js/_scrollable.js","./_sidebar-pc":"/Code/html/themes/themekit/lib/layout/js/_sidebar-pc.js","./_skins":"/Code/html/themes/themekit/lib/layout/js/_skins.js"}],"/Code/html/themes/themekit/lib/sidebar/js/_breakpoints.js":[function(require,module,exports){
(function ($) {
    "use strict";
